...
public class HuffmanTree implements Serializable {
    ...
    public String encode(String message, BinaryTree<HuffData> huffmanTree) {
        ...
        //butun harfleri tek tek yardimci metoda gonderip kodlanmis halini aldim
        for (int i = 0; i < message.length(); ++i) {
            result = helper(huffmanTree, result, message.charAt(i));
        }
        return result;
    }

    /**
     * encode yapan yardimci fonksiyon recursive calisir ve kodu dondurur
     *
     * @param tree
     * @param result_
     * @param searchedChar
     * @return
     */
    private String helper(BinaryTree<HuffData> tree, String result_, char searchedChar) {

        if (tree.isLeaf()) {
            if (tree.getData().getSymbol().equals(searchedChar)) {
                return result_;
            }
            return "";
        } else {

            String str = helper(tree.getLeftSubtree(), result_ + "0", searchedChar);
            if (str.equals("")) {
                str = helper(tree.getRightSubtree(), result_ + "1", searchedChar);
            }
            return str;
        }
    }
    ...
    public String toString() {
        ...
        try {
            ...
            Logger.getLogger(HuffmanTree.class
...
// Insert solution to programming exercise 1, section 6, chapter 6 here
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        System.out.println("message:  " + message + "   code:" + Htree.encode(message, tree));
        System.out.println("message:  " + message1 + "   code:" + Htree.encode(message1, tree));
        System.out.println("message:  " + message2 + "   code:" + Htree.encode(message2, tree));
        System.out.println("message:  " + message3 + "   code:" + Htree.encode(message3, tree));
        System.out.println("message:  " + message4 + "   code:" + Htree.encode(message4, tree));
        System.out.println("message:  " + message5 + "   code:" + Htree.encode(message5, tree));
        System.out.println("message:  " + message6 + "   code:" + Htree.encode(message6, tree));
