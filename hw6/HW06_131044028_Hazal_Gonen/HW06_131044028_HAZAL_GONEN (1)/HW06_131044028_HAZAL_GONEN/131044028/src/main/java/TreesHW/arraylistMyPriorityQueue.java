 ...
 * @param <E> generic
 */
public class arraylistMyPriorityQueue<E> implements priorityQueue<E> {
     ...
     */
    public arraylistMyPriorityQueue(int cap, Comparator< E> comp) {
        if (cap < 1) {
     ...
     * @param comp comparator
     */
    public arraylistMyPriorityQueue(Comparator< E> comp) {
     ...
     * Constructor
     */
    public arraylistMyPriorityQueue() {
        arrList = new ArrayList<>();
    }
