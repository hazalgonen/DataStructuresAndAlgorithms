...
// Insert solution to programming exercise 1, section 4, chapter 6 here
    ...
    /**
     * bu class agaci kucukten buyuge dogru gezmeyi saglar next hasNext remove
     * metodlari var
     */
    private class MyIterator implements Iterator<E> {

        /**
         * agactaki butun elemanlari kucukten buyuge tutar
         */
        private LinkedList<E> InOrderAllDataInTree = new LinkedList<>();

        /**
         * listeyi kucukten buyuge dogru dolduran recursive fonksiyonu cagirir
         *
         * @param root baslanacak olan agacin rootu
         */
        public MyIterator(Node<E> root) {

            //recursive fonksiyon
            InOrderAllDataInTree = fillLinkedList(root, InOrderAllDataInTree);

        }

        /**
         * sonraki eleman var mi kontrolu yapar
         *
         * @return yoksa 0 varsa 1 dondurur
         */
        @Override
        public boolean hasNext() {
            return !InOrderAllDataInTree.isEmpty();
        }

        /**
         * bir sonraki elemani dondurur eger yoksa exception firlatir
         *
         * @return sonraki eleman
         */
        @Override
        public E next() {
            if (!hasNext()) {
                ...
                //bir sonraki eleman listenin ilk elemanidir
                E current = InOrderAllDataInTree.removeFirst();
                return current;
            }
        }

        /**
         * Recursive olarak butun agaci kucukten buyuge linkedliste ekler
         *
         * @param root ilk bastaki root
         * @param currentLinkedList doldurulacak liste
         * @return doldurulan liste
         */
        private LinkedList<E> fillLinkedList(Node<E> root, LinkedList<E> currentLinkedList) {
            //root null ise null dondurup recursive biter
            if (root == null) {
                return null;
            } else {

                //sol taraf 
                fillLinkedList(root.left, currentLinkedList);

                //kendisini ekler
                currentLinkedList.add(root.data);

                //sag taraf
                fillLinkedList(root.right, currentLinkedList);
            }
    ...
    /**
     * iterator metodu agaci bastan sonra recursive olarak dolasir
     *
     * @return
     */
...
// Insert solution to programming exercise 3, section 4, chapter 6 here
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Butun elemanlar:");
