 ...
 * @author hazal
 */
public class arraylistMyPriorityQueueTest {
    ...
    public void testIsEmpty() {
        ...
        priorityQueue<Integer> arraylistMyPriorityQueue1 = new arraylistMyPriorityQueue<>(comp);
        boolean result = arraylistMyPriorityQueue1.isEmpty();
        System.out.println("Yeni olusturdugum bir priorityqueuenun isEmpty metodu: " + result);
        for (int i = 0; i < 10; ++i) {

            arraylistMyPriorityQueue1.enqueue(i);
        }
        result = arraylistMyPriorityQueue1.isEmpty();
    ...
    public void testDequeue() {
        ...
        System.out.println(arraylistMyPriorityQueue1.dequeue());
    }
    ...
    public void testSize() {
        ...
        int result = arraylistMyPriorityQueue1.size();
